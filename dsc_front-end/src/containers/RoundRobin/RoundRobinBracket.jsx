...
const saveResults = async () => {
  ...
  <Button
    ...
    style={{
      backgroundColor: editMode ? '#f0f0f0' : '#4CAF50', // Màu nền cho button tùy chỉnh
      color: editMode ? '#333' : 'white', // Màu chữ cho button tùy chỉnh
      border: editMode ? '1px solid #d9d9d9' : '1px solid #4CAF50', // Viền của button
    }}
  >
  ...
  {editMode && (
    <Button
      ...
      loading={loading}
      style={{
        backgroundColor: '#4CAF50', // Màu nền cho button Lưu Kết Quả
        color: 'white', // Màu chữ cho button
        border: '1px solid #4CAF50', // Viền của button
      }}
    >
      Lưu Kết Quả
    </Button>
